...
class DetailActivity : AppCompatActivity() {
    ...
    private val fragmentModel by viewModels<FragmentViewModel>()
    private val followingModel by viewModels<FollowerViewModel>()
    ...
    private fun subscribe() {
        ...
        if (username != null) {
            ...
            fragmentModel.followApi(username)
            followingModel.followApi(username)
        }
